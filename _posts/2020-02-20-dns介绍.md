...
## 7. dns安全
主要是两种：dos主要dns服务器和伪造dns记录（dns挟持，dns污染）。

运营商dns挟持，修改dns记录，返回新的地址，将原来内容包括在iframe中，另外新增广告页面。现在基本这种情况很少了，访问https页面，因为证书的关系，能够防止dns挟持。

还有一些国外的网站，因为防火墙或者运营商的dns污染，返回来的ip地址都是错的。造成不能正常访问某些网站。
